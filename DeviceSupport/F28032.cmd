...
// F28032.cmd
//
// Linker Command File For F28032 Device
// This file is used to allocate various components of the program to
// seperate locations in the global address space - RAM, registers, and Flash
// all use the same address space.
//
// $Copyright: $Copyright: Copyright (C) LDO Motors
//###########################################################################
*/
...
PAGE 0:    /* Program Memory */
   ...
   FLASHD      : origin = 0x3F2000, length = 0x003000     /* on-chip FLASH */
...
SECTIONS
{
   ...
   .cinit              : > FLASHA      PAGE = 0		/*Initalized global and static variables*/
   .pinit              : > FLASHA,     PAGE = 0		/*Table of C++ constructors called at startup*/
   .text               : > FLASHD      PAGE = 0		/*Executable code and constants*/
   ...
   .stack              : > RAML3       PAGE = 1		/*Stack space*/
   .ebss               : > RAMM0       PAGE = 1		/*Global and static variables*/
   .esysmem            : > RAML1       PAGE = 1		/*Memory for malloc type functions*/
